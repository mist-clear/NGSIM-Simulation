...
mat_data = loadmat('trajectories_I80.mat')
trajectories = mat_data['trajectories']

# Section limits
section_limits = [200, 800]
...
for i in range(len(frames)):
    ...
    # Set title
    plt.title(f'NGSIM I80 trajectories - frame: {int(frames[i])}')

    # Plot road boundaries
    plt.plot(x_limit, [0, 0], color='blue', linestyle='--')
